...
def welcomeScreen():
    ...
    messagex = int((SCREENWIDTH - GAME_SPRITES['message'].get_height())/3)
...
def mainGame():
    ...
    while True:
        ...
        # add a new pipe when first is about to cross 
...
def isCollide(playerx, playery, upperPipes, lowerPipes):
    ...
    for pipe in upperPipes:
        ...
        if(playery<pipeHight + pipe['y'] and abs(playerx - pipe['x']) < GAME_SPRITES['pipe'][0].get_width()):
             GAME_SOUND['hit'].play()
             return True 
...
def getRandomPipe():
    ...
    """generate positions of two pipes(one upword and one downword)"""
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('flappy bird by smruti')
